...
public class ExcelCommon {
    ...
    public static final String STUDENT_INFO_XLS_PATH = LIB_PATH + "student-info" + POINT + OFFICE_EXCEL_2003_POSTFIX;
    public static final String STUDENT_INFO_XLSX_PATH = LIB_PATH + "student-info" + POINT + OFFICE_EXCEL_2010_POSTFIX;
