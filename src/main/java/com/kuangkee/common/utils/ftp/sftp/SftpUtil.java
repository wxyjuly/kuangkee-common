...
public final class SftpUtil {
     ...
     */
    public static final void uploadFile(String host, int port, String username, String password, String directory, String uploadFile) {
    ...
    public static void main(String[] args) {
    	String host = "120.78.176.153" ;
    	int port = 22 ;
    	String username = "root" ;
    	String password ="hello#2018/*-" ;
    	String directory = "/usr/java_soft/installed/kuanghee_static/resources/images/detail" ;
    	String uploadFile = "D:/20180225230550-Java.png" ;
    	
    	uploadFile(host, port, username, password, directory, uploadFile);
